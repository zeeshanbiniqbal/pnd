...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		apiError.setResponseMessage(ex.getBindingResult().getAllErrors().get(0).getDefaultMessage());
	...
	protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
		...
		if (ex.getCause() instanceof ConstraintViolationException) {
			return buildResponseEntity(new ApiError(HttpStatus.CONFLICT, CONTINUE.value(), ex.getCause(),
	...
	protected ResponseEntity<Object> handleEntityNotFound(EntityNotFoundException ex, HttpServletRequest request) {
		...
		apiError.setCode(HttpStatus.OK.value());
	...
	protected ResponseEntity<Object> handleAlreadyExistException(HttpServletRequest request, Exception ex) {
		ApiError apiError = new ApiError(CONFLICT);
		apiError.setResponseMessage(ex.getMessage());
		apiError.setCode(CONFLICT.value());
		apiError.setPath(request.getRequestURL().toString());
		return buildResponseEntity(apiError);
	}
	...
	protected ResponseEntity<Object> handleTypeNotFoundException(HttpServletRequest request, Exception ex) {
		ApiError apiError = new ApiError(BAD_REQUEST);
		apiError.setResponseMessage(ex.getMessage());
	...
	@ResponseStatus(BAD_REQUEST)
	protected ResponseEntity<Object> handleInvalidArgumentException(HttpServletRequest request, Exception ex) {
	...
	private ResponseEntity<Object> buildResponseEntity(ApiError apiError) {
		log.warn(EXCEPTION + apiError.getResponseMessage());
